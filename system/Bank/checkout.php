...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
            ...
            <h2><?php echo "Total Amount : GH₵" . $grand_total; ?></h2>
			</div>
    ...
    function log(){
		...
		var password = $('input[name=password]').val();
			if(email != ''){
				...
				$.ajax({url: 'check2.php', type:'POST',data: formData, dataType: "text", success: function(response){
					switch (response){
						case 'true':
						$('.login-email').replaceWith("<div class='login-email'> <?php echo "Account number " . $account_no . " your initial balance GH₵" . $initial . ". GH₵" . $grand_total . " will be deducted from your main Account"?>
